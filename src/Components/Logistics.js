...
const data = [
  {
   psin:"Loreum ipsum",name:"Loreum ipsum",address:"loreum ipsum",date:"loreum ipsum",price:"$1500",status:"Pending",track:"Track order" 
  },
  {
    psin:"Loreum ipsum",name:"Loreum ipsum",address:"loreum ipsum",date:"loreum ipsum",price:"$1500",status:"Pending",track:"Track order" 
  },
   ...
   <Logistics1>
    <div className='uppersection'>
        ...
        <div className='inputsection'>
          ...
          <input placeholder='       Search' style={{ width: '300px', height: '30px', marginTop: '10px',marginLeft:"100px" }}></input>
        </div>
